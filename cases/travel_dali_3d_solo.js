...
(function (g) {
  ...
  g.LOONA_CASES['travel_dali_3d_solo'] = {
    ...
    events: [
      ...
      { t: 300, gap_ms: 500, comp: 'tts', text: '一个人 3 天刚好，不赶。你不爱扎堆又爱拍，大理这点正对路——我先按你这口味，把必去的和好玩的点挑出来，再给你搭路线。', pace: 'mid' },
      ...
      { t: 1900, gap_ms: 500, comp: 'tts', text: '三天大致就这调子——头天松松落地，中间环洱海是重头，最后喜洲逛逛赶飞机，都不累。傍晚那段最值，我单说。左右划能看每天，哪天想多待你说一声。', pace: 'mid' },

      /* ===== ⑨ 重点（highlight Day2）：只讲王牌，傍晚龙龛日落给具体心动画面 ===== */
      { t: 0, gap_ms: 900, comp: 'tts', highlight: 'dali_d2', text: '这天你一个人骑着车绕洱海，想停哪就停哪。最值的是傍晚——骑到龙龛刚好太阳往湖里落，整片湖面金晃晃的，晃得眼睛疼也舍不得眨。找地方坐下看它一点点沉下去，那会儿特别安静。', pace: 'mid' },
