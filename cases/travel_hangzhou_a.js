...
(function (g) {
  ...
  g.LOONA_CASES['travel_hangzhou_a'] = {
    task_id: 'travel_hangzhou_a', title: '方案A · 杭州·封面卡钻取', scene: 'travel', default_skin: 'glass',
    ...
    events: [
      ...
      { t: 600, gap_ms: 320, comp: 'ClarifyCard', card_id: 'clarify', wait_for_user: true,
        tts: { text: '杭州三天记下了，偏好补不补都行，不补我按轻松出片来排。', pace: 'mid' },
      ...
      { t: 3900, gap_ms: 500, comp: 'tts', text: '杭州这三天我替你挑过，西湖灵隐宋城各占一天，天天有个非看不可的点。', pace: 'mid' },
      { t: 4400, gap_ms: 380, comp: 'tts', highlight: 's1', text: '头一天压轴是西湖日落，骑到苏堤那段最出片。', pace: 'mid' },
      { t: 4800, gap_ms: 380, comp: 'tts', highlight: 's2', text: '第二天钻灵隐，山里求个静，顺道喝当季龙井。', pace: 'mid' },
      { t: 5200, gap_ms: 380, comp: 'tts', highlight: 's3', text: '最后一天留给宋城千古情，这场是杭州招牌，别错过。', pace: 'mid' },
      { t: 5700, gap_ms: 800, comp: 'user_query', text: '第二天细说', drill_day: 'd2' },
      { t: 6000, gap_ms: 420, comp: 'tts', highlight: 'd2', text: '灵隐早去人最少，先拜后逛最舒服。', pace: 'mid' },
      { t: 6350, gap_ms: 340, comp: 'tts', highlight: 'd2', text: '中午法喜寺那素斋本地人都排，值得试。', pace: 'mid' },
      { t: 6700, gap_ms: 340, comp: 'tts', highlight: 'd2', text: '下午飞来峰石窟林子里凉快，傍晚龙井村收口。', pace: 'mid' }
    ], annotations: []
  };
})(window);
